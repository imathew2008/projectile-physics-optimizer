        ...
        MaterialTheme {
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                Canvas(Modifier.fillMaxSize()) bail@{
                    ...
                    drawLine(
                        Color.Black,
                        Offset(insetCenter.x - 10, insetCenter.y),
                        Offset(insetCenter.x + 10, insetCenter.y),
                        4f
                    )
                    ...
                    drawLine(
                        Color.Black,
                        Offset(insetCenter.x, insetCenter.y - 10),
                        Offset(insetCenter.x, insetCenter.y + 10),
                        4f
                    )
                    ...
                    for ((list, color) in topDownLists) {
                        for (i in 1 until list.size) {
                            ...
                            val insetMinX = insetTopLeft.x
                            val insetMaxX = insetTopLeft.x + insetSize
                            val insetMinY = insetTopLeft.y
                            val insetMaxY = insetTopLeft.y + insetSize

                            if ((a.x < insetMinX - 50 && b.x < insetMinX - 50) || (a.x > insetMaxX + 50 && b.x > insetMaxX + 50)) continue
                            if ((a.y < insetMinY - 50 && b.y < insetMinY - 50) || (a.y > insetMaxY + 50 && b.y > insetMaxY + 50)) continue
                ...
                Column(
                    ...
                    LegendRow(Color.Gray, "Initial guess")
                    LegendRow(Color.Red, "Initial guess + drag")
                    LegendRow(Color.Magenta, "Initial guess + drag + spin")
                    LegendRow(Color.Green, "Optimized result")
                    LegendRow(Color.Blue, "Optimized result + drag")
                    LegendRow(Color.Cyan, "Optimized result + drag + spin")
                }
            }
        }
    }
